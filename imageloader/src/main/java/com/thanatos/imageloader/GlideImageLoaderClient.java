...
import com.thanatos.imageloader.listener.IGetBitmapListener;
import com.thanatos.imageloader.listener.IGetDrawableListener;
import com.thanatos.imageloader.listener.IImageLoaderListener;
import com.thanatos.imageloader.listener.ImageSize;
import com.thanatos.imageloader.okhttp.OnGlideImageViewListener;
import com.thanatos.imageloader.okhttp.OnProgressListener;
import com.thanatos.imageloader.okhttp.ProgressManager;
import com.thanatos.imageloader.tranform.BlurBitmapTranformation;
import com.thanatos.imageloader.tranform.GlideCircleTransformation;
import com.thanatos.imageloader.tranform.RoundBitmapTranformation;
    ...
    public void disPlayImageProgress(Context context, final String url, ImageView imageView, int placeholderResId, int errorResId, OnGlideImageViewListener listener) {
        GlideApp.with(context)
                ...
                .listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        ...
                        ProgressManager.Companion.removeProgressListener(internalProgressListener);
                        return false;
                    }
        ...
        internalProgressListener = new OnProgressListener() {
            ...
            public void onProgress(String imageUrl, final long bytesRead, final long totalBytes, final boolean isDone, final GlideException exception) {
                ...
                if (isDone) {
                    ProgressManager.Companion.removeProgressListener(this);
                }
            }
        };
        ProgressManager.Companion.addProgressListener(internalProgressListener);
