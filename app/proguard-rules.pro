...
-keep public class [com.thanatos.app].R$*{
...
#---------------------------------自定义View的类------------------------
-keep class com.thanatos.app.view.** { *; }
-keep class com.anye.greendao.gen.**{ *; }
-keep class com.yanzhenjie.album.**{ *; }
-keep class com.thanatos.app.mvp.model.bean.**{ *; }
-keep class com.thanatos.app.utils.**{ *; }
-keep class com.thanatos.app.api.ErrorResponseBean
